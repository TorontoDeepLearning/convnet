#ifndef _CUDAMAT_CONV_CUH
#define _CUDAMAT_CONV_CUH
...
void convDown(cudamat* images, cudamat* filters, cudamat* targets,
              int imgSize, int paddingStart, int moduleStride,
              int numImgColors, int numGroups, float scaleTargets);

void convOutp(cudamat* images, cudamat* hidSums, cudamat* targets,
...
void localOutp(cudamat* images, cudamat* hidSums, cudamat* targets,
               int numModulesX, int filterSize, int paddingStart,
               int moduleStride, int numImgColors, int numGroups,
               float scaleTargets, float scaleOutput);

void ResponseNormCrossMap(cudamat* images, cudamat* denoms, cudamat* targets,
                          int numFilters, int sizeF, float addScale,
                          float powScale, bool blocked);

void ResponseNormCrossMapUndo(cudamat* outGrads, cudamat* denoms,
